...
-   **Migrations**: SQL migration files under `db/migrations/`
...
-   **Rate Limiting**: Custom Redis-backed limiter (using `go-redis/v9`).

## 4. Documentation & Testing

-   **Docs**: OpenAPI YAML (`docs/api/openapi.yaml`) + Swagger UI handler
